// This js file contains classes that imports answers and outputs final manipulation
const isColor = require('./isColor.js');

// Parent class that saves passed answers, if any, and create root svg
class Shape {
  constructor(answers) {
...
// ---- Inherit parent, pass data, and function declaration to each specific shape ----

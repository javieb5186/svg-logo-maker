// This algorithm takes in input, validates, and outputs to a file
...
class CLI {
  ...
  // ---- Constructor generates questions that validates answers ----
  constructor() {
    this.questions = [
      {
        type: "input",
  ...
  // - This function prompts the questions, chooses a shape user selected, output shape to file -
  run() {
